...
AI大模型学习卡片产品需求文档 v2.0 -- 面向AI从业者的碎片化知识记忆工具，通过每日抽卡与滑动交互，帮助用户系统掌握大模型核心概念。

**文档版本** v2.0 | **创建日期** 2026-07-07 | **更新日期** 2026-07-08 | **产品阶段** MVP + 二期规划 | **平台** 一期：单机版自适应离线网页（PWA）；二期：微信小程序
